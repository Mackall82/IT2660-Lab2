...
class Lab2 {
  ...
  public void stack() {
    ...
    bookStack.addElement("Clean Code");
    bookStack.addElement("Design Patterns");
    bookStack.addElement("Pragmatic Programer");
